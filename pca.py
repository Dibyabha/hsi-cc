...
plt.savefig('Figures/PA/cev.png', bbox_inches = 'tight')
# plt.savefig('Figures/SA/cev.png', bbox_inches = 'tight')
plt.show()
...
plt.savefig(f'Figures/PA/map_pcasvm_{pca.n_components_}_comps', bbox_inches = 'tight')
# plt.savefig(f'Figures/SA/map_pcasvm_{pca.n_components_}_comps', bbox_inches = 'tight')
plt.show()
